...
@NumberValidation({})
@NotBlankValidation({})
public class GetTaskFromSchool extends DefaultBusinessFunction {
	...
	public Domain handle(Domain taskDomain) {
		...
		Page<Task> taskPage = taskRepository.getTaskFromSchool(taskDomain.getLong("schoolId"), new PageRequest(page, size, Direction.DESC, "taskId"));
