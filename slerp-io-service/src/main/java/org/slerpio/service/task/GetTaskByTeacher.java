...
@Service
@KeyValidation({ "profileId", "page", "size" })
@NumberValidation({})
@NotBlankValidation({})
public class GetTaskByTeacher extends DefaultBusinessFunction {
	...
	public Domain handle(Domain taskDomain) {
		...
		Page<Task> taskPage = taskRepository.getTaskByTeacher(taskDomain.getLong("profileId"), new PageRequest(page, size, Direction.DESC, "taskId"));
