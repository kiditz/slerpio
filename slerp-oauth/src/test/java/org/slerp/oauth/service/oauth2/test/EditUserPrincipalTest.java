...
public class EditUserPrincipalTest extends AbstractTransactionalJUnit4SpringContextTests {
	...
	public void prepare() {
		...
		executeSqlScript("classpath:org/slerp/oauth/service/oauth2/test/EditUserPrincipalTest.sql", false);
	}
	...
	public void testSuccess() {
		...
		// Assertions.assertThat(userPrincipalDomain.get("hashedPassword")).isEqualTo(hashedPassword);
